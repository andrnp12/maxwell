...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Read Email | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
      ...
      <div class="row">
       <div class="col-12">
        ...
        <div class="email-leftbar card">
         <button class="btn btn-danger btn-block waves-effect waves-light" data-bs-target="#composemodal" data-bs-toggle="modal" type="button">
          Compose
         </button>
         ...
         <div class="card">
          ...
          <div class="card-body">
           <div class="d-flex align-items-center mb-4">
            <div class="flex-shrink-0 me-3">
             <img alt="Generic placeholder image" class="rounded-circle avatar-sm" src="assets/images/users/avatar-2.jpg"/>
            </div>
            <div class="flex-grow-1">
           ...
           <div class="row">
            <div class="col-xl-2 col-6">
             <div class="card">
              ...
              <div class="py-2 text-center">
               <a class="fw-medium" download="img-3.jpg" href="assets/images/small/img-3.jpg">
                Download
               </a>
              </div>
             </div>
            ...
            <div class="col-xl-2 col-6">
             <div class="card">
              <img alt="Card image cap" class="card-img-top img-fluid" src="assets/images/small/img-4.jpg"/>
              <div class="py-2 text-center">
               <a class="fw-medium" download="img-4.jpg" href="assets/images/small/img-4.jpg">
                Download
               </a>
              </div>
             </div>
