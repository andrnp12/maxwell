...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Form Validation | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
           ...
           <div class="row">
            <div class="col-md-6">
             <div class="mb-3">
              ...
              <input class="form-control" id="validationCustom01" placeholder="First name" required="" type="text" value="Mark"/>
           ...
           <div class="row">
            <div class="col-md-4">
             <div class="mb-3 position-relative">
              ...
              <input class="form-control" id="validationTooltip01" placeholder="First name" required="" type="text" value="Mark"/>
            ...
            <div class="col-md-4">
             <div class="mb-3 position-relative">
              ...
              <input class="form-control" id="validationTooltip02" placeholder="Last name" required="" type="text" value="Otto"/>
              <div class="valid-tooltip">
               Looks good!
              </div>
             </div>
            ...
            <div class="col-md-4">
             <div class="mb-3 position-relative">
              ...
              <div class="input-group">
               ...
               <input aria-describedby="validationTooltipUsernamePrepend" class="form-control" id="validationTooltipUsername" placeholder="Username" required="" type="text"/>
           ...
           <div class="row">
            <div class="col-md-6">
             <div class="mb-3 position-relative">
              ...
              <input class="form-control" id="validationTooltip03" placeholder="City" required="" type="text"/>
              <div class="invalid-tooltip">
               Please provide a valid city.
              </div>
             </div>
            ...
            <div class="col-md-6">
             <div class="mb-3 position-relative">
              ...
              <input class="form-control" id="validationTooltip04" placeholder="State" required="" type="text"/>
              <div class="invalid-tooltip">
               Please provide a valid state.
              </div>
             </div>
        ...
        <div class="card">
         ...
         <div class="card-body">
          <div>
           ...
           <form id="pristine-valid-example" method="post" novalidate="">
            <input type="hidden">
             <div class="row">
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" data-pristine-required-message="Please Enter a username" placeholder="First name" required="" type="text">
                </input>
               </div>
              </div>
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" data-pristine-required-message="Please Enter a Email" placeholder="Enter your Email" required="" type="email">
                </input>
               </div>
              </div>
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                <label>
                 Your age (required, min. 14)
                </label>
                <input class="form-control" data-pristine-min-message="You must be at least 14-years-old" min="14" placeholder="Enter your age" required="" type="number" value="10">
                </input>
               </div>
              </div>
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" data-pristine-pattern="/^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9]).{8,}$/" data-pristine-pattern-message="Minimum 8 characters, at least one uppercase letter, one lowercase letter and one number" data-pristine-required-message="Please Enter a password" id="pwd" placeholder="Enter your password" required="" type="password">
                </input>
               </div>
              </div>
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" data-pristine-equals="#pwd" data-pristine-equals-message="Passwords don't match" placeholder="Re-Enter your password" type="password">
                </input>
               </div>
              </div>
             </div>
             ...
             <div class="form-group mb-3 form-check">
              <input class="form-check-input" data-pristine-required-message="You must accept the terms and conditions" id="term-check01" name="future" required="" type="checkbox">
               <label class="form-check-label" for="term-check01">
          ...
          <div>
           ...
           <form id="pristine-valid-common" method="post" novalidate="">
            <input type="hidden">
             <div class="row">
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
              ...
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" minlength="5" placeholder="Minimum Length" type="text">
                </input>
               </div>
              </div>
              <div class="col-xl-4 col-md-6">
              ...
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" placeholder="Enter number" type="number">
                </input>
               </div>
              </div>
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" min="100" placeholder="Enter number" type="number">
                </input>
               </div>
              </div>
              <div class="col-xl-4 col-md-6">
             ...
             <div class="form-group mb-3 inline-label">
              ...
              <div>
               <div class="form-check form-check-inline">
                <input class="form-check-input" data-pristine-min-message="Select at least 2" id="hobbiecheck01" min="2" name="hobbie" required="" type="checkbox"/>
                <label class="form-check-label" for="hobbiecheck01">
                 Writing
                </label>
               </div>
               <div class="form-check form-check-inline">
                <input class="form-check-input" data-pristine-min-message="Select at least 2" id="hobbiecheck02" min="2" name="hobbie" required="" type="checkbox"/>
                <label class="form-check-label" for="hobbiecheck02">
                 Photography
                </label>
                <br/>
               </div>
               <div class="form-check form-check-inline">
                <input class="form-check-input" data-pristine-min-message="Select at least 2" id="hobbiecheck03" min="2" name="hobbie" required="" type="checkbox"/>
                <label class="form-check-label" for="hobbiecheck03">
                 Cycling
                </label>
               </div>
              </div>
             ...
             <div class="row">
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" pattern="/^\d+\.\d{2}$/g" placeholder="Two decimal digits with two points" required="" type="number"/>
               </div>
              </div>
              <div class="col-xl-4 col-md-6">
               <div class="form-group mb-3">
                ...
                <input class="form-control" data-pristine-pattern-message="The value must have 2 decimal points" pattern="/^\d+\.\d{2}$/g" placeholder="Write custom message" required="" type="number"/>
               </div>
              </div>
             </div>
             <div class="form-group">
          ...
          <div>
           ...
           <form id="pristine-valid-specificfield" method="post" novalidate="">
            <div class="form-group mb-3">
             <label class="form-label">
              required, first letter capitalized
             </label>
             <input class="form-control" id="specificfield" placeholder="Enter first letter capitalized" required="" type="text"/>
            </div>
            <div class="form-group">
             <button class="btn btn-primary" type="submit">
              Submit form
  ...
  <!-- pristine js -->
  <script src="assets/libs/pristinejs/pristine.min.js">
  </script>
  <!-- form validation -->
  <script src="assets/js/pages/form-validation.init.js">
  </script>
