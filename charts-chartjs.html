...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Chartjs | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <canvas class="chartjs-chart" data-colors='["rgba(81, 86, 190, 0.2)", "#5156be", "rgba(235, 239, 242, 0.2)", "#ebeff2"]' id="lineChart">
          </canvas>
         </div>
        </div>
       </div>
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <canvas class="chartjs-chart" data-colors='["rgba(41, 181, 125, 0.8)", "rgba(41, 181, 125, 0.9)"]' id="bar">
          </canvas>
         </div>
        </div>
       </div>
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <canvas class="chartjs-chart" data-colors='["#2ab57d", "#ebeff2"]' id="pieChart">
          </canvas>
         </div>
        </div>
       </div>
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <canvas class="chartjs-chart" data-colors='["#5156be", "#ebeff2"]' id="doughnut">
          </canvas>
         </div>
        </div>
       </div>
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <canvas class="chartjs-chart" data-colors='["#fd625e", "#2ab57d", "#ffbf53", "#5156be"]' id="polarArea">
          </canvas>
         </div>
        </div>
       </div>
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <canvas class="chartjs-chart" data-colors='["rgba(42, 181, 125, 0.2)", "#2ab57d", "rgba(81, 86, 190, 0.2)", "#5156be"]' id="radar">
          </canvas>
         </div>
        </div>
       </div>
  ...
  <!-- Chart JS -->
  <script src="assets/libs/chart.js/chart.umd.js">
  </script>
  <!-- chartjs init -->
  <script src="assets/js/pages/chartjs.init.js">
  </script>
