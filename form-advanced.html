...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Forms Advanced Plugins | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
          ...
          <div class="row">
           <div class="col-lg-6">
            ...
            <div class="d-flex flex-wrap gap-2">
             <input checked="" id="switch1" switch="none" type="checkbox">
              <label data-off-label="Off" data-on-label="On" for="switch1">
              </label>
              <input checked="" id="switch2" switch="default" type="checkbox">
               <label data-off-label="" data-on-label="" for="switch2">
               </label>
               <input checked="" id="switch3" switch="bool" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="switch3">
               </label>
               <input checked="" id="switch6" switch="primary" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="switch6">
               </label>
               <input checked="" id="switch4" switch="success" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="switch4">
               </label>
               <input checked="" id="switch7" switch="info" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="switch7">
               </label>
               <input checked="" id="switch5" switch="warning" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="switch5">
               </label>
               <input checked="" id="switch8" switch="danger" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="switch8">
               </label>
               <input checked="" id="switch9" switch="dark" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="switch9">
               </label>
              </input>
             </input>
            </div>
            ...
            <div class="mt-4 mt-lg-0">
             ...
             <div class="d-flex flex-wrap gap-2">
              <div class="square-switch">
               <input checked="" id="square-switch1" switch="none" type="checkbox"/>
               <label data-off-label="Off" data-on-label="On" for="square-switch1">
               </label>
              </div>
              <div class="square-switch">
               <input checked="" id="square-switch2" switch="info" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="square-switch2">
               </label>
              </div>
              <div class="square-switch">
               <input checked="" id="square-switch3" switch="bool" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="square-switch3">
               </label>
              </div>
              <div class="square-switch">
               <input checked="" id="square-switch4" switch="warning" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="square-switch4">
               </label>
              </div>
              <div class="square-switch">
               <input checked="" id="square-switch5" switch="danger" type="checkbox"/>
               <label data-off-label="No" data-on-label="Yes" for="square-switch5">
               </label>
              </div>
             </div>
            </div>
         ...
         <div class="card-body">
          <div>
           ...
           <div class="row">
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-single-default">
               Default
              </label>
              <select class="form-control" data-trigger="" id="choices-single-default" name="choices-single-default" placeholder="This is a search placeholder">
               <option value="">
            ...
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-single-groups">
               Option
                                                            groups
              </label>
              <select class="form-control" data-trigger="" id="choices-single-groups" name="choices-single-groups">
               <option value="">
                Choose a city
               </option>
               <optgroup label="UK">
            ...
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-single-no-search">
               Options added
            ...
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-single-no-sorting">
               Options added
                                                            via config with no search
              </label>
          ...
          <div class="mt-4">
           ...
           <div class="row">
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-multiple-default">
               Default
              </label>
              <select class="form-control" data-trigger="" id="choices-multiple-default" multiple="" name="choices-multiple-default" placeholder="This is a placeholder">
               ...
               <option disabled="" value="Choice 4">
                Choice 4
               </option>
              </select>
             </div>
            ...
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-multiple-remove-button">
               With
                                                            remove button
              </label>
              <select class="form-control" id="choices-multiple-remove-button" multiple="" name="choices-multiple-remove-button" placeholder="This is a placeholder">
               <option selected="" value="Choice 1">
                Choice 1
               </option>
               <option value="Choice 2">
            ...
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-multiple-groups">
               Option
                                                            groups
              </label>
              <select class="form-control" id="choices-multiple-groups" multiple="" name="choices-multiple-groups" placeholder="This is a placeholder">
               <option value="">
                Choose a city
               </option>
               <optgroup label="UK">
          ...
          <div class="mt-4">
           ...
           <div class="row">
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-text-remove-button">
               Limited to 5
                                                            values with remove button
              </label>
              <input class="form-control" id="choices-text-remove-button" placeholder="Enter something" type="text" value="Task-1,Task-2"/>
             </div>
            </div>
            <!-- end col -->
            <div class="col-lg-4 col-md-6">
             <div class="mb-3">
              <label class="form-label font-size-13 text-muted" for="choices-text-unique-values">
               Unique values
                                                            only, no pasting
              </label>
              <input class="custom class" id="choices-text-unique-values" placeholder="This is a placeholder" type="text" value="Project-A, Project-B"/>
             </div>
            </div>
            <!-- end col -->
           </div>
           <!-- end row -->
           <div>
            <label class="form-label font-size-13 text-muted" for="choices-text-disabled">
             Disabled
            </label>
            <input class="form-control" id="choices-text-disabled" placeholder="This is a placeholder" type="text" value="josh@joshuajohnson.co.uk, joe@bloggs.co.uk"/>
           </div>
          </div>
         </div>
         <!-- end card body -->
           ...
           <div class="row">
            ...
            <div class="col-lg-4">
             <div class="mt-4">
              ...
              <div class="monolith-colorpicker">
              </div>
             </div>
            </div>
            <div class="col-lg-4">
           ...
           <div class="row">
            <div class="col-lg-6">
             <div class="mb-3">
              ...
              <input class="form-control" id="datepicker-basic" type="text"/>
             </div>
             <div class="mb-3">
              <label class="form-label">
               DateTime
              </label>
              <input class="form-control" id="datepicker-datetime" type="text"/>
             </div>
             <div class="mb-3">
              <label class="form-label">
               Human-friendly Dates
              </label>
              <input class="form-control flatpickr-input" id="datepicker-humanfd" type="text"/>
             </div>
             <div class="mb-3">
              <label class="form-label">
               MinDate and MaxDate
              </label>
              <input class="form-control" id="datepicker-minmax" type="text"/>
             </div>
             <div class="mb-3">
              <label class="form-label">
               Disabling dates
              </label>
              <input class="form-control" id="datepicker-disable" type="text"/>
             </div>
             <div class="mb-3">
              <label class="form-label">
               Selecting multiple dates
              </label>
              <input class="form-control" id="datepicker-multiple" type="text"/>
             </div>
             <div>
              <label class="form-label">
               Range
              </label>
              <input class="form-control" id="datepicker-range" type="text"/>
             </div>
            </div>
            <div class="col-lg-6">
             <div class="mt-3 mt-lg-0">
              <div class="mb-3">
               ...
               <input class="form-control" id="datepicker-timepicker" type="text"/>
              </div>
              <div>
               <label class="form-label">
                Inline Date Picker Demo
               </label>
               <input class="form-control" id="datepicker-inline" type="text"/>
              </div>
             </div>
            </div>
           </div>
  ...
  <!-- color picker js -->
  <script src="assets/libs/@simonwep/pickr/pickr.min.js">
  </script>
  ...
  <!-- init js -->
  <script src="assets/js/pages/form-advanced.init.js">
  </script>
