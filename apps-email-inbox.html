...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Email Inbox | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
  ...
  <div id="layout-wrapper">
   ...
   <div class="main-content">
      ...
      <div class="row">
       <div class="col-12">
        ...
        <div class="email-leftbar card">
         <button class="btn btn-danger w-100 waves-effect waves-light" data-bs-target="#composemodal" data-bs-toggle="modal" type="button">
          Compose
         </button>
         <div class="mail-list mt-4">
          <a class="active" href="#">
           <i class="mdi mdi-email-outline me-2">
           </i>
           Inbox
          ...
          <a href="#">
           <i class="mdi mdi-star-outline me-2">
           </i>
           Starred
          </a>
          <a href="#">
           <i class="mdi mdi-diamond-stone me-2">
           </i>
           Important
          </a>
          <a href="#">
           <i class="mdi mdi-file-outline me-2">
           </i>
           Draft
          </a>
          <a href="#">
           <i class="mdi mdi-email-check-outline me-2">
           </i>
           Sent Mail
          </a>
          <a href="#">
           <i class="mdi mdi-trash-can-outline me-2">
           </i>
           Trash
          </a>
         </div>
         ...
         <div class="mail-list mt-1">
          <a href="#">
           <span class="mdi mdi-arrow-right-drop-circle text-info float-end">
           </span>
           Theme Support
          </a>
          <a href="#">
           <span class="mdi mdi-arrow-right-drop-circle text-warning float-end">
           </span>
           Freelance
          </a>
          <a href="#">
           <span class="mdi mdi-arrow-right-drop-circle text-primary float-end">
           </span>
           Social
          </a>
          <a href="#">
           <span class="mdi mdi-arrow-right-drop-circle text-danger float-end">
           </span>
           Friends
          </a>
          <a href="#">
           <span class="mdi mdi-arrow-right-drop-circle text-success float-end">
           </span>
           Family
          </a>
         </div>
         ...
         <div class="mt-2">
          <a class="d-flex align-items-start" href="javascript: void(0);">
           <img alt="Generic placeholder image" class="flex-shrink-0 me-3 rounded-circle" height="36" src="assets/images/users/avatar-2.jpg"/>
          ...
          <a class="d-flex align-items-start" href="javascript: void(0);">
           <img alt="Generic placeholder image" class="flex-shrink-0 me-3 rounded-circle" height="36" src="assets/images/users/avatar-3.jpg"/>
           <div class="flex-grow-1 chat-user-box">
            <p class="user-title m-0">
             Julian Rosa
            </p>
          ...
          <a class="d-flex align-items-start" href="javascript: void(0);">
           <img alt="Generic placeholder image" class="flex-shrink-0 me-3 rounded-circle" height="36" src="assets/images/users/avatar-4.jpg"/>
           <div class="flex-grow-1 chat-user-box">
            <p class="user-title m-0">
             David Medina
            </p>
          ...
          <a class="d-flex align-items-start" href="javascript: void(0);">
           <img alt="Generic placeholder image" class="flex-shrink-0 me-3 rounded-circle" height="36" src="assets/images/users/avatar-6.jpg"/>
           <div class="flex-grow-1 chat-user-box">
            <p class="user-title m-0">
             Jay Baker
            </p>
        ...
        <div class="email-rightbar mb-3">
         <div class="card">
          <div class="btn-toolbar gap-2 p-3" role="toolbar">
           <div class="btn-group">
            <button class="btn btn-primary waves-light waves-effect" type="button">
             <i class="fa fa-inbox">
             </i>
            </button>
            <button class="btn btn-primary waves-light waves-effect" type="button">
           ...
           <div class="btn-group">
            <button aria-expanded="false" class="btn btn-primary waves-light waves-effect dropdown-toggle" data-bs-toggle="dropdown" type="button">
           ...
           <div class="btn-group">
            <button aria-expanded="false" class="btn btn-primary waves-light waves-effect dropdown-toggle" data-bs-toggle="dropdown" type="button">
             More
             <i class="mdi mdi-dots-vertical ms-2">
             </i>
            </button>
            <div class="dropdown-menu">
             <a class="dropdown-item" href="#">
          ...
          <ul class="message-list">
           <li>
            <div class="col-mail col-mail-1">
             <div class="checkbox-wrapper-mail">
              <input id="chk19" type="checkbox"/>
              <label class="toggle" for="chk19">
              </label>
             </div>
             <a class="title" href="#">
              Peter, me (3)
             </a>
             <span class="star-toggle far fa-star">
             </span>
            </div>
           ...
           <li>
            ...
            <div class="col-mail col-mail-2">
             <a class="subject" href="#">
              <span class="bg-warning badge me-2">
               Freelance
              </span>
              Since you asked... and i'm
           ...
           <li>
            ...
            <div class="col-mail col-mail-2">
             <a class="subject" href="#">
              <span class="bg-primary badge me-2">
               Social
              </span>
              This Week's Top Stories â
              <span class="teaser">
               Our top pick for you on Medium this week The Man Who Destroyed Americaâs Ego
              </span>
             </a>
             <div class="date">
              Feb 28
           ...
           <li>
            ...
            <div class="col-mail col-mail-2">
             <a class="subject" href="#">
              Sveriges Hetaste sommarjobb â
              <span class="teaser">
               Hej Nicklas Sandell! Vi vill bjuda in dig till "First tour 2014", ett rekryteringsevent som erbjuder jobb pÃ¥ 16 semesterorter iSverige.
              </span>
             </a>
             <div class="date">
              Mar 8
         ...
         <div class="row">
          ...
          <div class="col-5">
           <div class="btn-group float-end">
            <button class="btn btn-sm btn-success waves-effect" type="button">
    ...
    <!-- End Page-content -->
    <!-- Modal -->
    <div aria-hidden="true" aria-labelledby="composemodalTitle" class="modal fade" id="composemodal" role="dialog" tabindex="-1">
     <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content">
       ...
       <div class="modal-footer">
        ...
        <button class="btn btn-primary" type="button">
         Send
         <i class="fab fa-telegram-plane ms-1">
         </i>
        </button>
       </div>
      </div>
  ...
  <!--ckeditor js-->
  <script src="assets/libs/@ckeditor/ckeditor5-build-classic/build/ckeditor.js">
  </script>
  <!-- email editor init -->
  <script src="assets/js/pages/email-editor.init.js">
  </script>
