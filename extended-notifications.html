...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Notifications | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
        ...
        <div class="card">
         <div class="card-header">
          ...
          <p class="card-title-desc">
           Notifications examples of using AlertifyJS.
          </p>
         </div>
         <div class="card-body">
          ...
          <div class="row text-center">
           <div class="col-sm-4">
            <div class="my-4">
             ...
             <a class="btn btn-primary waves-effect waves-light" href="javascript: void(0);" id="alert">
              Click me
             </a>
            </div>
           </div>
           <div class="col-sm-4">
            <div class="my-4">
             ...
             <a class="btn btn-primary waves-effect waves-light" href="javascript: void(0);" id="alert-confirm">
              Click me
             </a>
            </div>
           </div>
           <div class="col-sm-4">
            <div class="my-4">
             ...
             <a class="btn btn-primary waves-effect waves-light" href="javascript: void(0);" id="alert-prompt">
              Click me
             </a>
            </div>
           </div>
           ...
           <table class="table mb-0">
            <tbody>
             <tr>
              ...
              <td>
               <a class="btn btn-primary btn-sm waves-effect waves-light" href="javascript: void(0);" id="alert-message">
                Click me
               </a>
              </td>
             </tr>
             <tr>
              ...
              <td>
               <a class="btn btn-primary btn-sm waves-effect waves-light" href="javascript: void(0);" id="alert-success">
                Click me
               </a>
              </td>
             </tr>
             <tr>
              ...
              <td>
               <a class="btn btn-primary btn-sm waves-effect waves-light" href="javascript: void(0);" id="alert-error">
                Click me
               </a>
              </td>
             </tr>
             <tr>
              ...
              <td>
               <a class="btn btn-primary btn-sm waves-effect waves-light" href="javascript: void(0);" id="alert-warning">
                Click me
               </a>
              </td>
             </tr>
  ...
  <!-- alertifyjs js -->
  <script src="assets/libs/alertifyjs/build/alertify.min.js">
  </script>
  <!-- notification init -->
  <script src="assets/js/pages/notification.init.js">
  </script>
