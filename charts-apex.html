...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Apexcharts | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#5156be", "#2ab57d"]' dir="ltr" id="line_chart_datalabel">
          </div>
         </div>
        </div>
        <!--end card-->
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#5156be", "#fd625e", "#2ab57d"]' dir="ltr" id="line_chart_dashed">
          </div>
         </div>
        </div>
        <!--end card-->
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#5156be", "#2ab57d"]' dir="ltr" id="spline_area">
          </div>
         </div>
        </div>
        <!--end card-->
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#2ab57d", "#5156be", "#fd625e"]' dir="ltr" id="column_chart">
          </div>
         </div>
        </div>
        <!--end card-->
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#5156be"]' dir="ltr" id="column_chart_datalabel">
          </div>
         </div>
        </div>
        <!--end card-->
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#2ab57d"]' dir="ltr" id="bar_chart">
          </div>
         </div>
        </div>
        <!--end card-->
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#fd625e", "#5156be", "#2ab57d"]' dir="ltr" id="mixed_chart">
          </div>
         </div>
        </div>
        <!--end card-->
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#5156be", "#2ab57d", "#fd625e", "#ffbf53"]' dir="ltr" id="radial_chart">
          </div>
         </div>
        </div>
        <!--end card-->
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#2ab57d", "#5156be", "#fd625e", "#4ba6ef", "#ffbf53"]' dir="ltr" id="pie_chart">
          </div>
         </div>
        </div>
       </div>
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="apex-charts" data-colors='["#2ab57d", "#5156be", "#fd625e", "#4ba6ef", "#ffbf53"]' dir="ltr" id="donut_chart">
          </div>
         </div>
        </div>
       </div>
  ...
  <!-- apexcharts init -->
  <script src="assets/js/pages/apexcharts.init.js">
  </script>
