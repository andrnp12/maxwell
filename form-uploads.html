...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   File Upload | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
         ...
         <div class="card-header">
          ...
          <p class="card-title-desc">
           DropzoneJS is an open source library
                                            that provides dragânâdrop file uploads with image previews.
          </p>
         </div>
         <div class="card-body">
          <div>
           <form action="#" class="dropzone">
            ...
            <div class="dz-message needsclick">
             <div class="mb-3">
              <i class="display-4 text-muted bx bx-cloud-upload">
              </i>
             </div>
             <h5>
  ...
  <!-- dropzone js -->
  <script src="assets/libs/dropzone/min/dropzone.min.js">
  </script>
