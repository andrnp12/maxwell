...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Blog Details | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
           ...
           <div class="mt-4">
            <div class="text-muted font-size-14">
             ...
             <blockquote class="p-4 border-light border rounded mb-4">
              <div class="d-flex">
               <div class="me-3">
                <i class="bx bxs-quote-alt-left text-body font-size-24">
                </i>
               </div>
               <div>
                <p class="mb-0">
            ...
            <div class="mt-5">
             <h5 class="font-size-15">
              <i class="bx bx-message-dots text-muted align-middle me-1">
              </i>
              Comments :
             </h5>
             <div>
              ...
              <div class="row">
               <div class="col-md-6">
                <div class="mb-3">
                 ...
                 <input class="form-control" id="commentname-input" placeholder="Enter name" type="text"/>
                </div>
               </div>
               <div class="col-md-6">
                <div class="mb-3">
                 ...
                 <input class="form-control" id="commentemail-input" placeholder="Enter email" type="email"/>
                </div>
               </div>
              </div>
              <div class="mb-3">
