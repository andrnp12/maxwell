...
<body>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered dt-responsive nowrap w-100" id="datatable">
                                        ...
                                        <tbody>
                                            <?php $i = 1; foreach ($dataKuis as $kuis) : ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            modalEditKuis.addEventListener('show.bs.modal', function(event) {
                ...
                fetch(`/../src/actions/proses_kuis.php?id=${idKuis}`)
            ...
            document.body.addEventListener('click', function(event) {
                if (event.target.classList.contains('btn-delete')) {
                    ...
                    if (konfirmasi) {
                        ...
                        fetch(`/../src/actions/proses_kuis.php?id=${id}`, {
                                method: 'DELETE'
                            })
                            .then(response => response.json())
                            .then(res => {
    ...
    <script>
        ...
        document.getElementById('btnEksekusiHapus').addEventListener('click', function() {
            ...
            // fetch(`/../src/actions/proses_delete_materi.php?id=${materiIdToDelete}`, {
            //         method: 'POST',
            //     })
            //     .then(response => response.json())
            //     .then(data => {
