...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Dripicons | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
         ...
         <div class="card-body">
          <div class="row icon-demo-content">
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-alarm">
            </i>
            dripicons-alarm
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-align-center">
            </i>
            dripicons-align-center
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-align-justify">
            </i>
            dripicons-align-justify
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-align-left">
            </i>
            dripicons-align-left
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-align-right">
            </i>
            dripicons-align-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-anchor">
            </i>
            dripicons-anchor
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-arrow-down">
            </i>
            dripicons-arrow-down
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-arrow-left">
            </i>
            dripicons-arrow-left
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-arrow-right">
            </i>
            dripicons-arrow-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-arrow-thin-down">
            </i>
            dripicons-arrow-thin-down
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-arrow-thin-left">
            </i>
            dripicons-arrow-thin-left
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-arrow-thin-right">
            </i>
            dripicons-arrow-thin-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-arrow-thin-up">
            </i>
            dripicons-arrow-thin-up
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-arrow-up">
            </i>
            dripicons-arrow-up
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-article">
            </i>
            dripicons-article
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-backspace">
            </i>
            dripicons-backspace
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-basket">
            </i>
            dripicons-basket
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-basketball">
            </i>
            dripicons-basketball
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-battery-empty">
            </i>
            dripicons-battery-empty
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-battery-full">
            </i>
            dripicons-battery-full
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-battery-low">
            </i>
            dripicons-battery-low
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-battery-medium">
            </i>
            dripicons-battery-medium
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-bell">
            </i>
            dripicons-bell
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-bluetooth">
            </i>
            dripicons-bluetooth
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-bold">
            </i>
            dripicons-bold
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-bookmark">
            </i>
            dripicons-bookmark
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-bookmarks">
            </i>
            dripicons-bookmarks
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-box">
            </i>
            dripicons-box
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-brightness-low">
            </i>
            dripicons-brightness-low
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-brightness-max">
            </i>
            dripicons-brightness-max
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-brightness-medium">
            </i>
            dripicons-brightness-medium
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-broadcast">
            </i>
            dripicons-broadcast
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-browser">
            </i>
            dripicons-browser
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-browser-upload">
            </i>
            dripicons-browser-upload
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-brush">
            </i>
            dripicons-brush
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-calendar">
            </i>
            dripicons-calendar
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-camcorder">
            </i>
            dripicons-camcorder
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-camera">
            </i>
            dripicons-camera
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-cart">
            </i>
            dripicons-cart
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-checklist">
            </i>
            dripicons-checklist
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-chevron-down">
            </i>
            dripicons-chevron-down
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-chevron-left">
            </i>
            dripicons-chevron-left
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-chevron-right">
            </i>
            dripicons-chevron-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-chevron-up">
            </i>
            dripicons-chevron-up
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-clipboard">
            </i>
            dripicons-clipboard
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-clockwise">
            </i>
            dripicons-clockwise
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-cloud">
            </i>
            dripicons-cloud
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-cloud-download">
            </i>
            dripicons-cloud-download
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-cloud-upload">
            </i>
            dripicons-cloud-upload
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-code">
            </i>
            dripicons-code
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-contract">
            </i>
            dripicons-contract
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-contract-2">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-crosshair">
            </i>
            dripicons-crosshair
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-cutlery">
            </i>
            dripicons-cutlery
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-device-mobile">
            </i>
            dripicons-device-mobile
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-device-tablet">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-disc">
            </i>
            dripicons-disc
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-document">
            </i>
            dripicons-document
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-document-new">
            </i>
            dripicons-document-new
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-document-remove">
            </i>
            dripicons-document-remove
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-dot">
            </i>
            dripicons-dot
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-dots-2">
            </i>
            dripicons-dots-2
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-dots-3">
            </i>
            dripicons-dots-3
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-download">
            </i>
            dripicons-download
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-duplicate">
            </i>
            dripicons-duplicate
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-enter">
            </i>
            dripicons-enter
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-expand">
            </i>
            dripicons-expand
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-expand-2">
            </i>
            dripicons-expand-2
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-experiment">
            </i>
            dripicons-experiment
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-export">
            </i>
            dripicons-export
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-feed">
            </i>
            dripicons-feed
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-flag">
            </i>
            dripicons-flag
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-flashlight">
            </i>
            dripicons-flashlight
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-folder">
            </i>
            dripicons-folder
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-folder-open">
            </i>
            dripicons-folder-open
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-forward">
            </i>
            dripicons-forward
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-gaming">
            </i>
            dripicons-gaming
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-graph-pie">
            </i>
            dripicons-graph-pie
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-headset">
            </i>
            dripicons-headset
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-heart">
            </i>
            dripicons-heart
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-help">
            </i>
            dripicons-help
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-hourglass">
            </i>
            dripicons-hourglass
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-inbox">
            </i>
            dripicons-inbox
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-information">
            </i>
            dripicons-information
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-italic">
            </i>
            dripicons-italic
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-lifting">
            </i>
            dripicons-lifting
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-lightbulb">
            </i>
            dripicons-lightbulb
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-link">
            </i>
            dripicons-link
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-link-broken">
            </i>
            dripicons-link-broken
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-list">
            </i>
            dripicons-list
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-loading">
            </i>
            dripicons-loading
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-location">
            </i>
            dripicons-location
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-media-pause">
            </i>
            dripicons-media-pause
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-media-play">
            </i>
            dripicons-media-play
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-media-previous">
            </i>
            dripicons-media-previous
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-media-record">
            </i>
            dripicons-media-record
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-media-shuffle">
            </i>
            dripicons-media-shuffle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-media-stop">
            </i>
            dripicons-media-stop
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-medical">
            </i>
            dripicons-medical
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-menu">
            </i>
            dripicons-menu
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-message">
            </i>
            dripicons-message
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-monitor">
            </i>
            dripicons-monitor
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-move">
            </i>
            dripicons-move
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-music">
            </i>
            dripicons-music
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-network-1">
            </i>
            dripicons-network-1
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-network-2">
            </i>
            dripicons-network-2
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-network-3">
            </i>
            dripicons-network-3
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-network-4">
            </i>
            dripicons-network-4
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-network-5">
            </i>
            dripicons-network-5
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-pamphlet">
            </i>
            dripicons-pamphlet
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-paperclip">
            </i>
            dripicons-paperclip
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-pencil">
            </i>
            dripicons-pencil
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-photo">
            </i>
            dripicons-photo
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-photo-group">
            </i>
            dripicons-photo-group
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-pill">
            </i>
            dripicons-pill
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-pin">
            </i>
            dripicons-pin
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-power">
            </i>
            dripicons-power
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-preview">
            </i>
            dripicons-preview
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-print">
            </i>
            dripicons-print
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-pulse">
            </i>
            dripicons-pulse
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-question">
            </i>
            dripicons-question
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-reply">
            </i>
            dripicons-reply
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-reply-all">
            </i>
            dripicons-reply-all
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-return">
            </i>
            dripicons-return
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-retweet">
            </i>
            dripicons-retweet
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-rocket">
            </i>
            dripicons-rocket
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-scale">
            </i>
            dripicons-scale
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-skip">
            </i>
            dripicons-skip
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-stack">
            </i>
            dripicons-stack
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-stopwatch">
            </i>
            dripicons-stopwatch
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-store">
            </i>
            dripicons-store
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-suitcase">
            </i>
            dripicons-suitcase
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-swap">
            </i>
            dripicons-swap
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-tag">
            </i>
            dripicons-tag
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-tag-delete">
            </i>
            dripicons-tag-delete
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-tags">
            </i>
            dripicons-tags
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-thumbs-down">
            </i>
            dripicons-thumbs-down
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-thumbs-up">
            </i>
            dripicons-thumbs-up
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-ticket">
            </i>
            dripicons-ticket
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-time-reverse">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-trophy">
            </i>
            dripicons-trophy
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-upload">
            </i>
            dripicons-upload
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-user-id">
            </i>
            dripicons-user-id
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-vibrate">
            </i>
            dripicons-vibrate
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-view-apps">
            </i>
            dripicons-view-apps
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-volume-full">
            </i>
            dripicons-volume-full
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-volume-low">
            </i>
            dripicons-volume-low
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-volume-medium">
            </i>
            dripicons-volume-medium
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-volume-off">
            </i>
            dripicons-volume-off
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-wallet">
            </i>
            dripicons-wallet
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-warning">
            </i>
            dripicons-warning
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-weight">
            </i>
            dripicons-weight
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-wifi">
            </i>
            dripicons-wifi
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-wrong">
            </i>
            dripicons-wrong
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-zoom-in">
            </i>
            dripicons-zoom-in
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="dripicons-zoom-out">
            </i>
            dripicons-zoom-out
           </div>
          </div>
