...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Rating | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
          ...
          <div class="row">
           ...
           <div class="col-sm-6">
            <div class="p-lg-5 p-4 text-center" dir="ltr">
             ...
             <div class="align-middle" id="rater-onhover">
             </div>
           ...
           <div class="col-sm-6">
            <div class="p-lg-5 p-4 text-center" dir="ltr">
             ...
             <div class="align-middle" id="raterreset">
             </div>
             <span class="clear-rating">
             </span>
             <button class="btn btn-outline-primary btn-sm ms-2" id="raterreset-button">
              Reset
             </button>
            </div>
           </div>
  ...
  <!-- rating init -->
  <script src="assets/js/pages/rating.init.js">
  </script>
