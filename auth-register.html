       ...
       <div class="w-100">
        <div class="d-flex flex-column h-100">
         ...
         <div class="auth-content my-auto">
          ...
          <form action="index.html" class="needs-validation mt-4 pt-2" novalidate="">
           <div class="mb-3">
           ...
           <div class="mb-3">
            ...
            <input class="form-control" id="username" placeholder="Enter username" required="" type="text"/>
            <div class="invalid-feedback">
           ...
           <div class="mb-3">
            ...
            <input class="form-control" id="userpassword" placeholder="Enter password" required="" type="password"/>
            <div class="invalid-feedback">
