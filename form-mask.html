...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Form Mask | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
          ...
          <form>
           <div class="row">
            <div class="col-lg-6">
             <div>
              <div>
               <label class="form-label" for="regexp-mask">
              ...
              <div class="mt-4">
               <label class="form-label" for="phone-mask">
                Pattern (Phone)
               </label>
              ...
              <div class="mt-4">
               <label class="form-label" for="number-mask">
                Number
               </label>
            ...
            <div class="col-lg-6">
             <div class="mt-4 mt-lg-0">
              <div>
               <label class="form-label" for="date-mask">
                Date
               </label>
  ...
  <!-- form mask -->
  <script src="assets/libs/imask/imask.min.js">
  </script>
  <!-- form mask init -->
  <script src="assets/js/pages/form-mask.init.js">
  </script>
