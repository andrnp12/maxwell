...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Chat | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
             ...
             <ul class="list-unstyled chat-list">
               ...
               <a href="#">
                <div class="d-flex align-items-start">
                 <div class="flex-shrink-0 user-img away align-self-center me-3">
                  <img alt="" class="rounded-circle avatar-sm" src="assets/images/users/avatar-3.jpg"/>
                  <span class="user-status">
                  </span>
                 </div>
                 <div class="flex-grow-1 overflow-hidden">
               ...
               <a href="#">
                <div class="d-flex align-items-start">
                 <div class="flex-shrink-0 user-img align-self-center me-3">
                  <img alt="" class="rounded-circle avatar-sm" src="assets/images/users/avatar-4.jpg"/>
                  <span class="user-status">
                  </span>
                 </div>
                 <div class="flex-grow-1 overflow-hidden">
              ...
              <li>
               <a href="#">
                <div class="d-flex align-items-start">
                 <div class="flex-shrink-0 user-img align-self-center me-3">
                  <img alt="" class="rounded-circle avatar-sm" src="assets/images/users/avatar-5.jpg"/>
                  <span class="user-status">
                  </span>
                 </div>
                 <div class="flex-grow-1 overflow-hidden">
              ...
              <li>
               <a href="#">
                <div class="d-flex align-items-start">
                 <div class="flex-shrink-0 user-img align-self-center me-3">
                  <img alt="" class="rounded-circle avatar-sm" src="assets/images/users/avatar-6.jpg"/>
                  <span class="user-status">
                  </span>
                 </div>
                 <div class="flex-grow-1 overflow-hidden">
