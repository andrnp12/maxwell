...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   User List | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
         <div>
          <ul class="nav nav-pills">
           <li class="nav-item">
            <a class="nav-link active" data-bs-placement="top" data-bs-toggle="tooltip" href="apps-contacts-list.html" title="List">
             <i class="bx bx-list-ul">
             </i>
            </a>
           </li>
           <li class="nav-item">
            <a class="nav-link" data-bs-placement="top" data-bs-toggle="tooltip" href="apps-contacts-grid.html" title="Grid">
       ...
       <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
        ...
        <tbody>
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck1" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck1">
            </label>
           </div>
          </th>
          <td>
           <img alt="" class="avatar-sm rounded-circle me-2" src="assets/images/users/avatar-2.jpg"/>
          ...
          <td>
           <div class="dropdown">
            <button aria-expanded="false" class="btn btn-link font-size-16 shadow-none py-0 text-muted dropdown-toggle" data-bs-toggle="dropdown" type="button">
             <i class="bx bx-dots-horizontal-rounded">
             </i>
            </button>
            <ul class="dropdown-menu dropdown-menu-end">
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck2" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck2">
            </label>
           </div>
          </th>
          <td>
           <img alt="" class="avatar-sm rounded-circle me-2" src="assets/images/users/avatar-1.jpg"/>
           <a class="text-body" href="#">
            James Nix
           </a>
          </td>
          ...
          <td>
           jamesnix@StarCode Kh.com
          </td>
          <td>
           <div class="d-flex gap-2">
            <a class="badge bg-primary-subtle text-primary font-size-11" href="#">
             Html
            </a>
            <a class="badge bg-primary-subtle text-primary font-size-11" href="#">
             Css
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck3" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck3">
            </label>
           </div>
          </th>
          <td>
           <img alt="" class="avatar-sm rounded-circle me-2" src="assets/images/users/avatar-3.jpg"/>
           <a class="text-body" href="#">
            Darlene Smith
           </a>
          </td>
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck4" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck4">
            </label>
           </div>
          </th>
          <td>
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck5" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck5">
            </label>
           </div>
          </th>
          <td>
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck6" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck6">
            </label>
           </div>
          </th>
          <td>
           <img alt="" class="avatar-sm rounded-circle me-2" src="assets/images/users/avatar-6.jpg"/>
           <a class="text-body" href="#">
            Tommy Hayes
           </a>
          </td>
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck7" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck7">
            </label>
           </div>
          </th>
          <td>
           <img alt="" class="avatar-sm rounded-circle me-2" src="assets/images/users/avatar-8.jpg"/>
           <a class="text-body" href="#">
            Diana Owens
           </a>
          </td>
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck8" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck8">
            </label>
           </div>
          </th>
          <td>
           <img alt="" class="avatar-sm rounded-circle me-2" src="assets/images/users/avatar-9.jpg"/>
           <a class="text-body" href="#">
            Paul Sanchez
           </a>
          </td>
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck9" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck9">
            </label>
           </div>
          </th>
          <td>
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck10" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck10">
            </label>
           </div>
          </th>
          <td>
           <img alt="" class="avatar-sm rounded-circle me-2" src="assets/images/users/avatar-4.jpg"/>
           <a class="text-body" href="#">
            Gerald Moyer
           </a>
          </td>
         ...
         <tr>
          <th scope="row">
           <div class="form-check font-size-16">
            <input class="form-check-input" id="contacusercheck11" type="checkbox"/>
            <label class="form-check-label" for="contacusercheck11">
            </label>
           </div>
          </th>
          <td>
  ...
  <!-- init js -->
  <script src="assets/js/pages/datatable-pages.init.js">
  </script>
