...
<body>
    ...
    <div id="layout-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row d-sm-flex align-items-center justify-content-between mb-2">
                                ...
                                <p class="text-muted">
                                    Kerjakan soal pretest untuk mengukur pemahaman anda!.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- End Page-content -->
        <div aria-labelledby="exampleModalFullscreenLabel" class="modal fade" id="exampleModalFullscreen" tabindex="-1" style="display: none;" aria-hidden="true">
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Sebelum dapat menggunakan aplikasi dengan penuh, anda wajib
                            mengerjakan tes untuk mengukur pemahaman anda kedepannya.
                        </p>
                        <p>
                            Jika anda mengerti, tutup informasi ini dan silahkan memulai
                            tes anda sesuai dengan soal yang tersedia. Semoga berhasil!
                        </p>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-primary waves-effect waves-light" data-bs-dismiss="modal" type="button">
                            Kerjakan Pre-Test
                        </button>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            var modalEl = document.getElementById('exampleModalFullscreen');
