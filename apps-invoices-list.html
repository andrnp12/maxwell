...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Invoice List | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
           ...
           <table class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
            ...
            <tbody>
             <tr>
              ...
              <td>
               <a class="text-body fw-medium" href="javascript: void(0);">
                #MN0215
               </a>
              </td>
              <td>
              ...
              <td>
               <div>
                <button class="btn btn-soft-light btn-sm w-xs waves-effect btn-label waves-light" type="button">
                 <i class="bx bx-download label-icon">
                 </i>
                 Pdf
                </button>
               </div>
  ...
  <!-- init js -->
  <script src="assets/js/pages/invoices-list.init.js">
  </script>
