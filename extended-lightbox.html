...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Lightbox | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
           ...
           <div class="col-lg-3 col-sm-6">
            <div class="mt-4">
             <a class="image-popup" href="assets/images/small/img-1.jpg">
              <img alt="work-thumbnail" class="img-fluid" src="assets/images/small/img-1.jpg"/>
             </a>
            </div>
           </div>
           <div class="col-lg-3 col-sm-6">
            <div class="mt-4">
             <a class="image-popup" href="assets/images/small/img-2.jpg">
              <img alt="work-thumbnail" class="img-fluid" src="assets/images/small/img-2.jpg"/>
             </a>
            </div>
           </div>
          </div>
        ...
        <div class="card">
         ...
         <div class="card-body">
          <div class="row">
           <div class="col-lg-3 col-sm-6">
            <div class="mt-4">
             <a class="image-popup-desc" data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit" data-title="Project 01" href="assets/images/small/img-4.jpg">
              <img alt="work-thumbnail" class="img-fluid" src="assets/images/small/img-4.jpg"/>
             </a>
            </div>
           </div>
           <div class="col-lg-3 col-sm-6">
            <div class="mt-4">
             <a class="image-popup-desc" data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit" data-title="Project 02" href="assets/images/small/img-5.jpg">
              <img alt="work-thumbnail" class="img-fluid" src="assets/images/small/img-5.jpg"/>
             </a>
            </div>
           </div>
           <div class="col-lg-3 col-sm-6">
            <div class="mt-4">
             <a class="image-popup-desc" data-description="Lorem ipsum dolor sit amet, consectetuer adipiscing elit" data-title="Project 03" href="assets/images/small/img-1.jpg">
              <img alt="work-thumbnail" class="img-fluid" src="assets/images/small/img-1.jpg"/>
             </a>
            </div>
           </div>
        ...
        <div class="card">
         ...
         <div class="card-body">
          <div class="d-flex align-items-start gap-3 flex">
           <a class="btn btn-light image-popup-video-map" data-description="YouTube Video Popup" data-title="YouTube Video" href="https://www.youtube.com/watch?v=0O2aH4XLbto">
            Open YouTube Video
           </a>
           <a class="btn btn-light image-popup-video-map" data-description="Vimeo Video Popup" data-title="Vimeo Video" href="https://vimeo.com/45830194">
            Open Vimeo Video
           </a>
          </div>
         </div>
  ...
  <!-- lightbox init -->
  <script src="assets/js/pages/lightbox.init.js">
  </script>
