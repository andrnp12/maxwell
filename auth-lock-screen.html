...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Lock Screen | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
        ...
        <div class="d-flex flex-column h-100">
         ...
         <div class="auth-content my-auto">
          ...
          <div class="user-thumb text-center mb-4 mt-4 pt-2">
           <img alt="thumbnail" class="rounded-circle img-thumbnail avatar-lg" src="assets/images/users/avatar-1.jpg"/>
          ...
          <form action="index.html" class="mt-4">
           <div class="mb-3">
            ...
            <input class="form-control" id="userpassword" placeholder="Enter password" type="password"/>
           </div>
           <div class="mb-3 mt-4">
