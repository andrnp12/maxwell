...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Boxicons | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
        ...
        <div class="card">
         ...
         <div class="card-body">
          ...
          <div class="row icon-demo-content">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-meh-blank">
            </i>
            bx bx-meh-blank
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-happy-beaming">
            </i>
            bx bx-happy-beaming
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-shocked">
            </i>
            bx bx-shocked
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-confused">
            </i>
            bx bx-confused
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-wink-smile">
            </i>
            bx bx-wink-smile
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-happy-heart-eyes">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-wink-tongue">
            </i>
            bx bx-wink-tongue
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-meh-alt">
            </i>
            bx bx-meh-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-food-menu">
            </i>
            bx bx-food-menu
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-food-tag">
            </i>
            bx bx-food-tag
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-space-bar">
            </i>
            bx bx-space-bar
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-alarm-add">
            </i>
            bx bx-alarm-add
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-sort-z-a">
            </i>
            bx bx-sort-z-a
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-sort-a-z">
            </i>
            bx bx-sort-a-z
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-gas-pump">
            </i>
            bx bx-gas-pump
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-mobile-vibration">
            </i>
            bx bx-mobile-vibration
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-mobile-landscape">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-border-left">
            </i>
            bx bx-border-left
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-border-right">
            </i>
            bx bx-border-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-dialpad-alt">
            </i>
            bx bx-dialpad-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-no-entry">
            </i>
            bx bx-no-entry
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-message-alt-dots">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-cycling">
            </i>
            bx bx-cycling
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-shape-circle">
            </i>
            bx bx-shape-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-cylinder">
            </i>
            bx bx-cylinder
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-pyramid">
            </i>
            bx bx-pyramid
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-bug-alt">
            </i>
            bx bx-bug-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-mouse-alt">
            </i>
            bx bx-mouse-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-message-square">
            </i>
            bx bx-message-square
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-slideshow">
            </i>
            bx bx-slideshow
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-font-family">
            </i>
            bx bx-font-family
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-joystick-button">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-caret-down">
            </i>
            bx bx-caret-down
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-caret-right">
            </i>
            bx bx-caret-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-magnet">
            </i>
            bx bx-magnet
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-rewind-circle">
            </i>
            bx bx-rewind-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-grid-horizontal">
            </i>
            bx bx-grid-horizontal
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-move-vertical">
            </i>
            bx bx-move-vertical
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-font-size">
            </i>
            bx bx-font-size
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-handicap">
            </i>
            bx bx-handicap
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-dock-left">
            </i>
            bx bx-dock-left
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-dock-top">
            </i>
            bx bx-dock-top
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-dock-right">
            </i>
            bx bx-dock-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-dock-bottom">
            </i>
            bx bx-dock-bottom
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-notification-off">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-infinite">
            </i>
            bx bx-infinite
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-carousel">
            </i>
            bx bx-carousel
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-upvote">
            </i>
            bx bx-upvote
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-globe-alt">
            </i>
            bx bx-globe-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-skip-next-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-phone-outgoing">
            </i>
            bx bx-phone-outgoing
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-phone-incoming">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-git-compare">
            </i>
            bx bx-git-compare
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-git-commit">
            </i>
            bx bx-git-commit
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-cloud-lightning">
            </i>
            bx bx-cloud-lightning
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-cloud-light-rain">
            </i>
            bx bx-cloud-light-rain
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-cloud-drizzle">
            </i>
            bx bx-cloud-drizzle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-bookmark-plus">
            </i>
            bx bx-bookmark-plus
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-bookmark-minus">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-zoom-out">
            </i>
            bx bx-zoom-out
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-zoom-in">
            </i>
            bx bx-zoom-in
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-volume-mute">
            </i>
            bx bx-volume-mute
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-volume-low">
            </i>
            bx bx-volume-low
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-right-indent">
            </i>
            bx bx-right-indent
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-right-down-arrow-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-rewind">
            </i>
            bx bx-rewind
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-rectangle">
            </i>
            bx bx-rectangle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-left-top-arrow-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-left-down-arrow-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-folder-minus">
            </i>
            bx bx-folder-minus
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-first-page">
            </i>
            bx bx-first-page
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-fast-forward-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-down-arrow-circle">
            </i>
            bx bx-down-arrow-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bx-copyright">
            </i>
            bx bx-copyright
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
          ...
          <div class="row icon-demo-content">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-happy-alt">
            </i>
            bx bxs-happy-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-laugh">
            </i>
            bx bxs-laugh
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-meh-blank">
            </i>
            bx bxs-meh-blank
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-tired">
            </i>
            bx bxs-tired
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-happy-beaming">
            </i>
            bx bxs-happy-beaming
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-shocked">
            </i>
            bx bxs-shocked
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-sleepy">
            </i>
            bx bxs-sleepy
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-confused">
            </i>
            bx bxs-confused
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-meh-alt">
            </i>
            bx bxs-meh-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-dizzy">
            </i>
            bx bxs-dizzy
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-happy-heart-eyes">
            </i>
            bx bxs-happy-heart-eyes
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-angry">
            </i>
            bx bxs-angry
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-clinic">
            </i>
            bx bxs-clinic
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-hand-left">
            </i>
            bx bxs-hand-left
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-hand-down">
            </i>
            bx bxs-hand-down
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-caret-left-circle">
            </i>
            bx bxs-caret-left-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-caret-right-circle">
            </i>
            bx bxs-caret-right-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-caret-down-circle">
            </i>
            bx bxs-caret-down-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-caret-up-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-alarm-add">
            </i>
            bx bxs-alarm-add
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-archive-out">
            </i>
            bx bxs-archive-out
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-archive-in">
            </i>
            bx bxs-archive-in
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-brush-alt">
            </i>
            bx bxs-brush-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-layout">
            </i>
            bx bxs-layout
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-fast-forward-circle">
            </i>
            bx bxs-fast-forward-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-rewind-circle">
            </i>
            bx bxs-rewind-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-carousel">
            </i>
            bx bxs-carousel
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-customize">
            </i>
            bx bxs-customize
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-calendar-event">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-calendar-x">
            </i>
            bx bxs-calendar-x
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-calendar-minus">
            </i>
            bx bxs-calendar-minus
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-calendar-plus">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-user-check">
            </i>
            bx bxs-user-check
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-user-x">
            </i>
            bx bxs-user-x
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-zoom-out">
            </i>
            bx bxs-zoom-out
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-zoom-in">
            </i>
            bx bxs-zoom-in
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-search">
            </i>
            bx bxs-search
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-bell-minus">
            </i>
            bx bxs-bell-minus
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-bell-plus">
            </i>
            bx bxs-bell-plus
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-folder-minus">
            </i>
            bx bxs-folder-minus
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-mobile">
            </i>
            bx bxs-mobile
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-skip-next-circle">
            </i>
            bx bxs-skip-next-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-skip-previous-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-institution">
            </i>
            bx bxs-institution
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-left-down-arrow-circle">
            </i>
            bx bxs-left-down-arrow-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-left-top-arrow-circle">
            </i>
            bx bxs-left-top-arrow-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-right-down-arrow-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-rectangle">
            </i>
            bx bxs-rectangle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-brightness">
            </i>
            bx bxs-brightness
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-credit-card-alt">
            </i>
            bx bxs-credit-card-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-band-aid">
            </i>
            bx bxs-band-aid
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-purchase-tag-alt">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-message-alt-dots">
            </i>
            bx bxs-message-alt-dots
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-message-alt">
            </i>
            bx bxs-message-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-notification-off">
            </i>
            bx bxs-notification-off
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-notification">
            </i>
            bx bxs-notification
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-polygon">
            </i>
            bx bxs-polygon
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-square-rounded">
            </i>
            bx bxs-square-rounded
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-square">
            </i>
            bx bxs-square
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-comment-add">
            </i>
            bx bxs-comment-add
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-droplet-half">
            </i>
            bx bxs-droplet-half
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-search-alt-2">
            </i>
            bx bxs-search-alt-2
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-bowling-ball">
            </i>
            bx bxs-bowling-ball
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-cylinder">
            </i>
            bx bxs-cylinder
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-pyramid">
            </i>
            bx bxs-pyramid
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-comment">
            </i>
            bx bxs-comment
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-traffic">
            </i>
            bx bxs-traffic
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-landscape">
            </i>
            bx bxs-landscape
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-adjust-alt">
            </i>
            bx bxs-adjust-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-file-gif">
            </i>
            bx bxs-file-gif
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-file-jpg">
            </i>
            bx bxs-file-jpg
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-file-png">
            </i>
            bx bxs-file-png
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-file-txt">
            </i>
            bx bxs-file-txt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-file-md">
            </i>
            bx bxs-file-md
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-file-js">
            </i>
            bx bxs-file-js
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-file-css">
            </i>
            bx bxs-file-css
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-file-html">
            </i>
            bx bxs-file-html
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-copy-alt">
            </i>
            bx bxs-copy-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-quote-single-right">
            </i>
            bx bxs-quote-single-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-quote-single-left">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-direction-left">
            </i>
            bx bxs-direction-left
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-video-recording">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-bug-alt">
            </i>
            bx bxs-bug-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-mouse-alt">
            </i>
            bx bxs-mouse-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-message-square-dots">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-eyedropper">
            </i>
            bx bxs-eyedroppers
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-cloud-lightning">
            </i>
            bx bxs-cloud-lightning
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-cloud-rain">
            </i>
            bx bxs-cloud-rain
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-joystick-button">
            </i>
            bx bxs-joystick-button
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-direction-right">
            </i>
            bx bxs-direction-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-directions">
            </i>
            bx bxs-directions
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-landmark">
            </i>
            bx bxs-landmark
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-gas-pump">
            </i>
            bx bxs-gas-pump
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-right-arrow-square">
            </i>
            bx bxs-right-arrow-square
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-down-arrow-square">
            </i>
            bx bxs-down-arrow-square
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-up-arrow-square">
            </i>
            bx bxs-up-arrow-square
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-left-arrow-square">
            </i>
            bx bxs-left-arrow-square
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-ambulance">
            </i>
            bx bxs-ambulance
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-magnet">
            </i>
            bx bxs-magnet
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-checkbox-checked">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-rocket">
            </i>
            bx bxs-rocket
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-certification">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-battery-low">
            </i>
            bx bxs-battery-low
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-folder-open">
            </i>
            bx bxs-folder-open
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-upvote">
            </i>
            bx bxs-upvote
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-up-arrow-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-to-top">
            </i>
            bx bxs-to-top
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-terminal">
            </i>
            bx bxs-terminal
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-ruler">
            </i>
            bx bxs-ruler
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-right-arrow-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-phone-outgoing">
            </i>
            bx bxs-phone-outgoing
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-phone-incoming">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-microphone">
            </i>
            bx bxs-microphone
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-microphone-off">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-left-arrow-circle">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-joystick">
            </i>
            bx bxs-joystick
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-joystick-alt">
            </i>
            bx bxs-joystick-alt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-eject">
            </i>
            bx bxs-eject
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-duplicate">
            </i>
            bx bxs-duplicate
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-droplet">
            </i>
            bx bxs-droplet
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-drink">
            </i>
            bx bxs-drink
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-downvote">
            </i>
            bx bxs-downvote
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-down-arrow-circle">
            </i>
            bx bxs-down-arrow-circle
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-dock-top">
            </i>
            bx bxs-dock-top
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-dock-right">
            </i>
            bx bxs-dock-right
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-captions">
            </i>
            bx bxs-captions
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-calculator">
            </i>
            bx bxs-calculator
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-battery-full">
            </i>
            bx bxs-battery-full
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-battery-charging">
            </i>
            bx bxs-battery-charging
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-battery">
            </i>
            bx bxs-battery
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-barcode">
            </i>
            bx bxs-barcode
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-award">
            </i>
            bx bxs-award
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-folder-plus">
            </i>
            bx bxs-folder-plus
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-alarm-off">
            </i>
            bx bxs-alarm-off
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-alarm">
            </i>
            bx bxs-alarm
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxs-adjust">
            </i>
            bx bxs-adjust
           </div>
          </div>
          ...
          <div class="row icon-demo-content">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-figma">
            </i>
            bx bxl-figma
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-audible">
            </i>
            bx bxl-audible
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-squarespace">
            </i>
            bx bxl-squarespace
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-medium-old">
            </i>
            bx bxl-medium-old
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-mailchimp">
            </i>
            bx bxl-mailchimp
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-soundcloud">
            </i>
            bx bxl-soundcloud
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-snapchat">
            </i>
            bx bxl-snapchat
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-microsoft">
            </i>
            bx bxl-microsoft
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-yahoo">
            </i>
            bx bxl-yahoo
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-bootstrap">
            </i>
            bx bxl-bootstrap
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-redux">
            </i>
            bx bxl-redux
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-chrome">
            </i>
            bx bxl-chrome
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-dailymotion">
            </i>
            bx bxl-dailymotion
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-joomla">
            </i>
            bx bxl-joomla
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-internet-explorer">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-wordpress">
            </i>
            bx bxl-wordpress
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-periscope">
            </i>
            bx bxl-periscope
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-firefox">
            </i>
            bx bxl-firefox
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-stack-overflow">
            </i>
            bx bxl-stack-overflow
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-magento">
            </i>
            bx bxl-magento
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-product-hunt">
            </i>
            bx bxl-product-hunt
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-airbnb">
            </i>
            bx bxl-airbnb
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-opera">
            </i>
            bx bxl-opera
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-invision">
            </i>
            bx bxl-invision
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-foursquare">
            </i>
            bx bxl-foursquare
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-drupal">
            </i>
            bx bxl-drupal
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-dropbox">
            </i>
            bx bxl-dropbox
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-deviantart">
            </i>
            bx bxl-deviantart
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-digitalocean">
            </i>
            bx bxl-digitalocean
           </div>
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-creative-commons">
            </i>
           ...
           <div class="col-xl-3 col-lg-4 col-sm-6">
            <i class="bx bxl-google-plus-circle">
            </i>
