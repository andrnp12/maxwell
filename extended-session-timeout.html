...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Session Timeout | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
  ...
  <!-- Session timeout js -->
  <script src="assets/libs/@curiosityx/bootstrap-session-timeout/index.js">
  </script>
  <!-- Session timeout init js -->
  <script src="assets/js/pages/session-timeout.init.js">
  </script>
