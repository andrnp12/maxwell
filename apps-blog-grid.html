...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Blog Grid | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
     ...
     <div class="container-fluid">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
         <div>
          <ul class="nav nav-pills">
           <li class="nav-item">
            <a class="nav-link" data-bs-placement="top" data-bs-toggle="tooltip" href="apps-blog-list.html" title="List">
             <i class="bx bx-list-ul">
             </i>
            </a>
           </li>
           <li class="nav-item">
            <a class="nav-link active" data-bs-placement="top" data-bs-toggle="tooltip" href="apps-blog-grid.html" title="Grid">
      ...
      <div class="row">
       ...
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         <div class="">
          <img alt="" class="img-fluid" src="assets/images/small/img-2.jpg"/>
         </div>
         <div class="card-body">
          <p class="text-muted mb-2">
           24 May, 2022
       ...
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         <div class="">
          <img alt="" class="img-fluid" src="assets/images/small/img-4.jpg"/>
         </div>
         <div class="card-body">
          <p class="text-muted mb-2">
           10 July, 2022
