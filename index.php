                     ...
                     <div class="col-xl-5">
                        ...
                        <div class="card card-h-100">
                           ...
                           <div class="card-body">
                              ...
                              <div class="row align-items-center">
                                 <div class="col-sm">
                                    <div class="apex-charts" data-colors='["#777aca", "#5156be", "#a8aada"]' id="wallet-balance">
                                    </div>
                                 </div>
                           ...
                           <div class="col-xl-4">
                              ...
                              <div class="card bg-primary text-white shadow-primary card-h-100">
                                 ...
                                 <div class="card-body p-0">
                                    <div class="carousel slide text-center widget-carousel" data-bs-ride="carousel" id="carouselExampleCaptions">
                        ...
                        <div class="card">
                           ...
                           <div class="card-body">
                              ...
                              <div class="row align-items-center">
                                 <div class="col-xl-8">
                                    <div>
                                       <div class="apex-charts" data-colors='["#5156be", "#34c38f"]' id="market-overview">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-xl-4">
                                    <div class="p-4">
                                       <div class="mt-0">
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="flex-shrink-0">
                                                <span class="badge rounded-pill bg-success-subtle text-success font-size-12 fw-medium">
                                                +2.5%
                                                </span>
                                             </div>
                                          </div>
                                       ...
                                       <div class="mt-3">
                                          <div class="d-flex align-items-center">
                                             ...
                                             <div class="flex-shrink-0">
                                                <span class="badge rounded-pill bg-danger-subtle text-danger font-size-12 fw-medium">
                                                -3.6%
                                                </span>
                                             </div>
                                          </div>
                        ...
                        <div class="card">
                           ...
                           <div class="card-body">
                              <div class="d-flex flex-wrap align-items-center mb-4">
                                 ...
                                 <div class="ms-auto">
                                    <div class="dropdown">
                                       <a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle text-reset" data-bs-toggle="dropdown" href="#" id="dropdownMenuButton1">
                              ...
                              <div data-colors='["#5156be"]' id="sales-by-locations" style="height: 250px">
                              </div>
                              <div class="px-2 py-2">
                                 <p class="mb-1">
                                    USA
                                 ...
                                 <div class="progress mt-2" style="height: 6px;">
                                    <div aria-valuemax="75" aria-valuemin="0" aria-valuenow="75" class="progress-bar progress-bar-striped bg-primary" role="progressbar" style="width: 75%">
                                    </div>
                                 </div>
                                 <p class="mt-3 mb-1">
                                    Russia
                                 ...
                                 <div class="progress mt-2" style="height: 6px;">
                                    <div aria-valuemax="55" aria-valuemin="0" aria-valuenow="55" class="progress-bar progress-bar-striped bg-primary" role="progressbar" style="width: 55%">
                                    </div>
                                 </div>
                                 <p class="mt-3 mb-1">
                                    Australia
                                 ...
                                 <div class="progress mt-2" style="height: 6px;">
                                    <div aria-valuemax="85" aria-valuemin="0" aria-valuenow="85" class="progress-bar progress-bar-striped bg-primary" role="progressbar" style="width: 85%">
                                    </div>
                                 </div>
                              </div>
                           </div>
                                 ...
                                 <div class="tab-pane active" id="buy-tab" role="tabpanel">
                                    <div class="float-end ms-2">
                                       <h5 class="font-size-14">
                                          <i class="bx bx-wallet text-primary font-size-16 align-middle me-1">
                                          </i>
                                    ...
                                    <div>
                                       ...
                                       <div>
                                          ...
                                          <div class="input-group mb-3">
                                             ...
                                             <input class="form-control" placeholder="0.00121255" type="text"/>
                                          </div>
                                          <div class="input-group mb-3">
                                             <label class="input-group-text">
                                             Price
                                             </label>
                                             <input class="form-control" placeholder="$58,245" type="text"/>
                                             <label class="input-group-text">
                                             $
                                             </label>
                                          </div>
                                          <div class="input-group mb-3">
                                             ...
                                             <input class="form-control" placeholder="$36,854.25" type="text"/>
                                          </div>
                                       </div>
                                       <div class="text-center">
                                          <button class="btn btn-success w-md" type="button">
                                          Buy Coin
                                          </button>
                                       </div>
                                    </div>
                                 ...
                                 <div class="tab-pane" id="sell-tab" role="tabpanel">
                                    ...
                                    <div>
                                       <div class="form-group mb-3">
                                          ...
                                          <input class="form-control" placeholder="1cvb254ugxvfcd280ki" type="email"/>
                                       </div>
                                       <div>
                                          <label>
                                          Add Amount :
                                          ...
                                          <div class="input-group mb-3">
                                             ...
                                             <input class="form-control" placeholder="$23,754.25" type="text"/>
                                             <label class="input-group-text">
                                             $
                                             </label>
                                          </div>
                                          <div class="input-group mb-3">
                                             ...
                                             <input class="form-control" placeholder="$6,852.41" type="text"/>
                                          </div>
                                       </div>
                                       <div class="text-center">
                                          <button class="btn btn-danger w-md" type="button">
                                          Sell Coin
                                          </button>
                                       </div>
                                    </div>
                                             ...
                                             <tr>
                                                <td style="width: 50px;">
                                                   <div class="font-size-22 text-success">
                                                      <i class="bx bx-down-arrow-circle d-block">
                                                      </i>
                                                   </div>
                                                </td>
                                                <td>
                                             ...
                                             <tr>
                                                <td>
                                                   <div class="font-size-22 text-danger">
                                                      <i class="bx bx-up-arrow-circle d-block">
                                                      </i>
                                                   </div>
                                                </td>
                                                <td>
                                 ...
                                 <ul class="list-unstyled activity-wid mb-0">
                                    <li class="activity-list activity-border">
                                       <div class="activity-icon avatar-md">
                                          ...
                                          <i class="bx bx-bitcoin font-size-24">
                                          </i>
                                          </span>
                                       </div>
                                       <div class="timeline-list-item">
                                          <div class="d-flex">
                                             ...
                                             <div class="flex-shrink-0 text-end">
                                                <div class="dropdown">
                                                   <a aria-haspopup="true" class="text-muted dropdown-toggle font-size-24" data-bs-toggle="dropdown" role="button">
                                    ...
                                    <li class="activity-list activity-border">
                                       <div class="activity-icon avatar-md">
                                          ...
                                          <i class="mdi mdi-ethereum font-size-24">
                                          </i>
                                          </span>
                                       </div>
                                       <div class="timeline-list-item">
                                    ...
                                    <li class="activity-list activity-border">
                                       <div class="activity-icon avatar-md">
                                          <span class="avatar-title bg-primary-subtle text-primary rounded-circle">
                                          <i class="mdi mdi-litecoin font-size-24">
                                          </i>
                                          </span>
                                       </div>
                                       <div class="timeline-list-item">
