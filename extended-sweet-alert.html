...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   SweetAlert 2 | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
            ...
            <tbody>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="sa-basic" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="sa-title" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="sa-success" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="sa-warning" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="sa-params" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="sa-image" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="sa-close" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="custom-html-alert" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="sa-position" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="custom-padding-width-alert" type="button">
                Click me
               </button>
              </td>
             </tr>
             <tr>
              ...
              <td class="text-center">
               <button class="btn btn-primary btn-sm waves-effect waves-light" id="ajax-alert" type="button">
                Click me
               </button>
              </td>
             </tr>
  ...
  <!-- Sweet alert init js-->
  <script src="assets/js/pages/sweetalert.init.js">
  </script>
