...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Calendar | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
         ...
         <div class="col-xl-3 col-lg-4">
          <div class="card">
           <div class="card-body">
            ...
            <div class="mt-2" id="external-events">
             <br/>
             <p class="text-muted">
            ...
            <div class="row justify-content-center mt-5">
             <div class="col-lg-12 col-sm-6">
              <img alt="" class="img-fluid d-block" src="assets/images/undraw-calendar.svg"/>
             </div>
            </div>
           </div>
          </div>
         ...
         <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
           ...
           <div class="modal-body p-4">
            <form class="needs-validation" id="form-event" name="event-form" novalidate="">
             ...
             <div class="row">
              <div class="col-12">
               <div class="mb-3">
                ...
                <input class="form-control" id="event-title" name="title" placeholder="Insert Event Name" required="" type="text" value="">
              ...
              <div class="col-12">
               <div class="mb-3">
                ...
                <select class="form-control form-select" id="event-category" name="category">
                 <option selected="">
                  --Select--
                 </option>
             ...
             <div class="row mt-2">
              ...
              <div class="col-6 d-flex text-end">
               <button class="btn btn-light me-1" data-bs-dismiss="modal" type="button">
                Close
               </button>
               <button class="btn btn-success" id="btn-save-event" type="submit">
                Save
               </button>
               <button class="btn btn-success" id="edit-event-btn" type="submit">
                Update
               </button>
              </div>
             </div>
  ...
  <!-- calendar min js -->
  <script src="assets/libs/fullcalendar/index.global.min.js">
  </script>
  <!-- Calendar init -->
  <script src="assets/js/pages/calendar.init.js">
  </script>
  <!-- App js -->
