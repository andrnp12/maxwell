...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Range Slider | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
          ...
          <div>
           ...
           <div class="mb-5">
            <div class="row">
             ...
             <div class="col-lg-9">
              ...
              <div class="sliders" id="green">
              </div>
              <div class="sliders" id="blue">
              </div>
              <div id="result">
              </div>
             </div>
            ...
            <div class="row">
             ...
             <div class="col-lg-9">
              ...
              <div class="d-flex flex-wrap">
               ...
               <input class="form-control" id="input-number" max="40" min="-20" step="1" type="number"/>
              </div>
             </div>
            </div>
           </div>
           ...
           <div class="mb-5">
            <div class="row">
             ...
             <div class="col-lg-9">
              ...
              <span class="example-val mt-2" id="slider2-span">
              </span>
              <button class="btn btn-primary" id="lockbutton" style="float: right; margin: 20px 0 0;">
               Lock
              </button>
             </div>
            </div>
           ...
           <div class="mb-5">
            <div class="row">
             ...
             <div class="col-lg-9">
              <div class="slider" id="slider-hide">
              </div>
             </div>
            </div>
           </div>
           <div class="mb-5">
            <div class="row">
             ...
             <div class="col-lg-9">
              <div class="slider" id="slider-color">
              </div>
             </div>
            </div>
           </div>
  ...
  <script src="assets/libs/wnumb/wNumb.min.js">
  </script>
  <!-- range slider init -->
  <script src="assets/js/pages/rangeslider.init.js">
  </script>
