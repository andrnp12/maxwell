...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Blog List | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
    ...
    <div class="page-content">
     <div class="container-fluid">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
         <div>
          <ul class="nav nav-pills">
           <li class="nav-item">
            <a class="nav-link active" data-bs-placement="top" data-bs-toggle="tooltip" href="apps-blog-list.html" title="List">
             <i class="bx bx-list-ul">
             </i>
            </a>
           </li>
           <li class="nav-item">
            <a class="nav-link" data-bs-placement="top" data-bs-toggle="tooltip" href="apps-blog-grid.html" title="Grid">
      ...
      <div class="row">
       <div class="col-xl-8">
        <div class="card">
         <img alt="" class="img-fluid" src="assets/images/small/img-3.jpg"/>
         <div class="card-body">
          ...
          <div class="mt-3">
           <a class="align-middle font-size-15" href="#">
            Read more
        ...
        <!-- end card -->
        <div class="card">
         <img alt="" class="img-fluid" src="assets/images/small/img-5.jpg"/>
         <div class="card-body">
          <p class="text-muted mb-2">
           22 May, 2022
          </p>
          <h5 class="">
           <a class="text-body" href="#">
            Working day with our new ideas
           </a>
          </h5>
          <p class="mb-0 font-size-15">
        ...
        <!-- end card -->
        <div class="card">
         <img alt="" class="img-fluid" src="assets/images/small/img-1.jpg"/>
         <div class="card-body">
          <p class="text-muted mb-2">
           12 june, 2022
          </p>
         ...
         <div class="card-body">
          <div class="search-box">
           ...
           <div class="position-relative px-2">
            <input class="form-control rounded bg-light border-light" placeholder="Search..." type="text"/>
          ...
          <div class="mt-5">
           ...
           <ul class="list-unstyled fw-medium px-2">
            <li>
             <a class="text-body pb-3 d-block border-bottom" href="javascript: void(0);">
              Design
            ...
            <li>
             <a class="text-body py-3 d-block border-bottom" href="javascript: void(0);">
              Development
            ...
            <li>
             <a class="text-body pt-3 pb-0 d-block" href="javascript: void(0);">
              Travel
              <span class="badge bg-primary-subtle text-primary rounded-pill ms-1 float-end font-size-12">
               10
              </span>
           ...
           <div class="list-group list-group-flush">
            <a class="list-group-item text-muted pb-3 pt-0 px-2" href="javascript: void(0);">
             <div class="d-flex align-items-center">
              <div class="flex-shrink-0 me-3">
               <img alt="" class="avatar-lg h-auto d-block rounded" src="assets/images/small/img-7.jpg"/>
              </div>
            ...
            <a class="list-group-item text-muted py-3 px-2" href="javascript: void(0);">
             <div class="d-flex align-items-center">
              <div class="flex-shrink-0 me-3">
               <img alt="" class="avatar-lg h-auto d-block rounded" src="assets/images/small/img-2.jpg"/>
              </div>
              <div class="flex-grow-1 overflow-hidden">
               <h5 class="font-size-13 text-truncate">
                Drawing a sketch
            ...
            <a class="list-group-item text-muted py-3 px-2" href="javascript: void(0);">
             <div class="d-flex align-items-center">
              <div class="flex-shrink-0 me-3">
               <img alt="" class="avatar-lg h-auto d-block rounded" src="assets/images/small/img-6.jpg"/>
              </div>
              <div class="flex-grow-1 overflow-hidden">
               <h5 class="font-size-13 text-truncate">
                Project discussion with team
            ...
            <a class="list-group-item text-muted py-3 px-2" href="javascript: void(0);">
             <div class="d-flex align-items-center">
              <div class="flex-shrink-0 me-3">
               <img alt="" class="avatar-lg h-auto d-block rounded" src="assets/images/small/img-1.jpg"/>
              </div>
              <div class="flex-grow-1 overflow-hidden">
               <h5 class="font-size-13 text-truncate">
                Coffee with friends
          ...
          <div class="mt-5">
           ...
           <div class="gap-2 hstack flex-wrap px-2">
            <img alt="" class="avatar-xl rounded" src="assets/images/small/img-3.jpg"/>
            <img alt="" class="avatar-xl rounded" src="assets/images/small/img-1.jpg"/>
            <img alt="" class="avatar-xl rounded" src="assets/images/small/img-2.jpg"/>
            <img alt="" class="avatar-xl rounded" src="assets/images/small/img-4.jpg"/>
            <img alt="" class="avatar-xl rounded" src="assets/images/small/img-5.jpg"/>
            <img alt="" class="avatar-xl rounded" src="assets/images/small/img-6.jpg"/>
           </div>
          </div>
          <div class="mt-5">
           <h5 class="mb-3">
