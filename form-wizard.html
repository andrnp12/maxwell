...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Form Wizard | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
  ...
  <meta content="Premium Multipurpose Admin &amp; Dashboard Template" name="description">
   ...
   <link href="assets/libs/twitter-bootstrap-wizard/prettify.css" rel="stylesheet"/>
   <!-- preloader css -->
 ...
 <body>
  ...
  <div id="layout-wrapper">
   ...
   <div class="main-content">
         ...
         <div class="card-body">
          <div class="twitter-bs-wizard" id="basic-pills-wizard">
           <ul class="twitter-bs-wizard-nav">
            <li class="nav-item">
             <a class="nav-link" data-toggle="tab" href="#seller-details">
              <div class="step-icon" data-bs-placement="top" data-bs-toggle="tooltip" title="Seller Details">
            ...
            <li class="nav-item">
             <a class="nav-link" data-toggle="tab" href="#company-document">
              <div class="step-icon" data-bs-placement="top" data-bs-toggle="tooltip" title="Company Document">
            ...
            <li class="nav-item">
             <a class="nav-link" data-toggle="tab" href="#bank-detail">
              <div class="step-icon" data-bs-placement="top" data-bs-toggle="tooltip" title="Bank Details">
               <i class="bx bxs-bank">
               </i>
              </div>
             </a>
            ...
            <div class="tab-pane" id="seller-details">
             ...
             <form>
              <div class="row">
               <div class="col-lg-6">
                <div class="mb-3">
                 <label class="form-label" for="basicpill-firstname-input">
                  First name
                 </label>
                 <input class="form-control" id="basicpill-firstname-input" placeholder="Enter Your First Name" type="text"/>
                </div>
               </div>
               <div class="col-lg-6">
                <div class="mb-3">
                 <label class="form-label" for="basicpill-lastname-input">
                  Last name
                 </label>
                 <input class="form-control" id="basicpill-lastname-input" placeholder="Enter Your Last Name" type="text"/>
                </div>
               </div>
              </div>
              <div class="row">
               <div class="col-lg-6">
                <div class="mb-3">
                 <label class="form-label" for="basicpill-phoneno-input">
                  Phone
                 </label>
                 <input class="form-control" id="basicpill-phoneno-input" placeholder="Enter your Phone No." type="text"/>
                </div>
               </div>
               <div class="col-lg-6">
                <div class="mb-3">
                 <label class="form-label" for="basicpill-email-input">
                  Email
                 </label>
                 <input class="form-control" id="basicpill-email-input" placeholder="Enter your email" type="email"/>
                </div>
               </div>
              </div>
              <div class="row">
               <div class="col-lg-12">
                <div class="mb-3">
                 <label class="form-label" for="basicpill-address-input">
                  Address
                 </label>
                 <textarea class="form-control" id="basicpill-address-input" placeholder="Enter your Address" rows="2"></textarea>
                </div>
               </div>
              </div>
             </form>
               ...
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  ...
                  <input class="form-control" id="basicpill-pancard-input" placeholder="Enter your PAN No." type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
                  ...
                  <input class="form-control" id="basicpill-vatno-input" placeholder="Enter your VAT/TIN No." type="text"/>
                 </div>
                </div>
               </div>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  ...
                  <input class="form-control" id="basicpill-cstno-input" placeholder="Enter your GST No." type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
                  ...
                  <input class="form-control" id="basicpill-servicetax-input" placeholder="Enter your Service Tex No." type="text"/>
                 </div>
                </div>
               </div>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  ...
                  <input class="form-control" id="basicpill-companyuin-input" placeholder="Enter your Company UIN." type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="basicpill-declaration-input">
                   Declaration
                  </label>
                  <input class="form-control" id="basicpill-declaration-input" placeholder="Enter your Declaration" type="text"/>
                 </div>
                </div>
               </div>
              </form>
             ...
             <div>
              ...
              <form>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="basicpill-namecard-input">
                   Name on Card
                  </label>
                  <input class="form-control" id="basicpill-namecard-input" placeholder="Enter your Name on Card" type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
               ...
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="basicpill-cardno-input">
                   Credit Card Number
                  </label>
                  <input class="form-control" id="basicpill-cardno-input" placeholder="Enter your Credit Card Number" type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="basicpill-card-verification-input">
                   Card Verification Number
                  </label>
                  <input class="form-control" id="basicpill-card-verification-input" placeholder="Enter your Card Verification Number" type="text"/>
                 </div>
                </div>
               </div>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="basicpill-expiration-input">
                   Expiration Date
                  </label>
                  <input class="form-control" id="basicpill-expiration-input" type="date"/>
                 </div>
                </div>
               </div>
              </form>
              <ul class="pager wizard twitter-bs-wizard-pager-link">
               ...
               <li class="float-end">
                <a class="btn btn-primary" data-bs-target=".confirmModal" data-bs-toggle="modal" href="javascript: void(0);">
                 Save
                                                                    Changes
                </a>
               </li>
         ...
         <div class="card-body">
          <div class="twitter-bs-wizard" id="progrss-wizard">
           <ul class="twitter-bs-wizard-nav nav nav-pills nav-justified">
            <li class="nav-item">
             <a class="nav-link" data-toggle="tab" href="#progress-seller-details">
              <div class="step-icon" data-bs-placement="top" data-bs-toggle="tooltip" title="Seller Details">
               <i class="bx bx-list-ul">
               </i>
              </div>
            ...
            <li class="nav-item">
             <a class="nav-link" data-toggle="tab" href="#progress-company-document">
              <div class="step-icon" data-bs-placement="top" data-bs-toggle="tooltip" title="Company Document">
               <i class="bx bx-book-bookmark">
               </i>
              </div>
            ...
            <li class="nav-item">
             <a class="nav-link" data-toggle="tab" href="#progress-bank-detail">
              <div class="step-icon" data-bs-placement="top" data-bs-toggle="tooltip" title="Bank Details">
               <i class="bx bxs-bank">
               </i>
              </div>
              ...
              <div class="row">
               <div class="col-lg-6">
                <div class="mb-3">
                 ...
                 <input class="form-control" id="progresspill-firstname-input" placeholder="Enter your First Name" type="text"/>
                </div>
               </div>
               <div class="col-lg-6">
                <div class="mb-3">
                 ...
                 <input class="form-control" id="progresspill-lastname-input" placeholder="Enter your Last Name" type="text"/>
                </div>
               </div>
              </div>
              <div class="row">
               <div class="col-lg-6">
                <div class="mb-3">
                 ...
                 <input class="form-control" id="progresspill-phoneno-input" placeholder="Enter your Phone No" type="text"/>
                </div>
               </div>
               <div class="col-lg-6">
                <div class="mb-3">
                 ...
                 <input class="form-control" id="progresspill-email-input" placeholder="Enter your Email" type="email"/>
                </div>
               </div>
              </div>
              <div class="row">
               <div class="col-lg-12">
                <div class="mb-3">
                 ...
                 <textarea class="form-control" id="progresspill-address-input" placeholder="Enter your address" rows="2"></textarea>
                </div>
               </div>
              </div>
             </form>
             ...
             <div>
              ...
              <form>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-pancard-input">
                   PAN Card
                  </label>
                  <input class="form-control" id="progresspill-pancard-input" placeholder="Enter your PAN Card No" type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-vatno-input">
                   VAT/TIN No.
                  </label>
                  <input class="form-control" id="progresspill-vatno-input" placeholder="Enter your VAT/TIN No" type="text"/>
                 </div>
                </div>
               </div>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-cstno-input">
                   CST No.
                  </label>
                  <input class="form-control" id="progresspill-cstno-input" placeholder="Enter your CST No" type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-servicetax-input">
                   Service Tax No.
                  </label>
                  <input class="form-control" id="progresspill-servicetax-input" placeholder="Enter your Service Tax No" type="text"/>
                 </div>
                </div>
               </div>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-companyuin-input">
                   Company UIN
                  </label>
                  <input class="form-control" id="progresspill-companyuin-input" placeholder="Enter your Company UIN" type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-declaration-input">
                   Declaration
                  </label>
                  <input class="form-control" id="progresspill-declaration-input" placeholder="Enter your Declaration" type="text"/>
                 </div>
                </div>
               </div>
              </form>
             ...
             <div>
              ...
              <form>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-namecard-input">
                   Name on Card
                  </label>
                  <input class="form-control" id="progresspill-namecard-input" placeholder="Enter your Name on Card" type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
               ...
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-cardno-input">
                   Credit Card Number
                  </label>
                  <input class="form-control" id="progresspill-cardno-input" placeholder="Enter your Credit Card Number" type="text"/>
                 </div>
                </div>
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-card-verification-input">
                   Card Verification Number
                  </label>
                  <input class="form-control" id="progresspill-card-verification-input" placeholder="Enter your Card Verification Number" type="text"/>
                 </div>
                </div>
               </div>
               <div class="row">
                <div class="col-lg-6">
                 <div class="mb-3">
                  <label class="form-label" for="progresspill-expiration-input">
                   Expiration Date
                  </label>
                  <input class="form-control" id="progresspill-expiration-input" type="date"/>
                 </div>
                </div>
               </div>
              </form>
    ...
    <!-- End Page-content -->
    <!-- Modal -->
    <div aria-hidden="true" class="modal fade confirmModal" tabindex="-1">
      ...
      <div class="modal-content">
       ...
       <div class="modal-body">
        <div class="text-center">
         <div class="mb-3">
          <i class="bx bx-check-circle display-4 text-success">
          </i>
         </div>
         <h5>
       ...
       <div class="modal-footer justify-content-center">
        <button class="btn btn-light w-md" data-bs-dismiss="modal" type="button">
         Close
        </button>
        <button class="btn btn-primary w-md" data-bs-dismiss="modal" type="button">
         Save changes
        </button>
       </div>
      </div>
