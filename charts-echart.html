...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Echarts | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="e-charts" data-colors='["#2ab57d", "#ccc"]' id="line-chart">
          </div>
         </div>
        </div>
        <!-- end card -->
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="e-charts" data-colors='["#2ab57d", "#5156be", "#fd625e"]' id="mix-line-bar">
          </div>
         </div>
        </div>
        <!-- end card -->
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="e-charts" data-colors='["#5156be", "#ffbf53", "#fd625e", "#4ba6ef", "#2ab57d"]' id="doughnut-chart">
          </div>
         </div>
        </div>
        <!-- end card -->
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="e-charts" data-colors='["#fd625e", "#2ab57d", "#4ba6ef", "#ffbf53", "#5156be"]' id="pie-chart">
          </div>
         </div>
        </div>
        <!-- end card -->
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="e-charts" data-colors='["#2ab57d"]' id="scatter-chart">
          </div>
         </div>
        </div>
        <!-- end card -->
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="e-charts" data-colors='["rgb(81, 86, 190)", "rgb(143, 148, 255)", "rgba(81, 86, 190, 0.5)", "rgb(42, 181, 125)", "rgb(111, 255, 203)",  "rgb(42, 181, 125, 0.5)"]' id="bubble-chart">
          </div>
         </div>
        </div>
        <!-- end card -->
      ...
      <div class="row">
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="e-charts" data-colors='["#5156be", "#2ab57d"]' id="candlestick-chart">
          </div>
         </div>
        </div>
        <!-- end card -->
       ...
       <div class="col-xl-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="e-charts" data-colors='["#2ab57d", "#5156be", "#fd625e"]' id="gauge-chart">
          </div>
         </div>
        </div>
        <!-- end card -->
  ...
  <!-- echarts js -->
  <script src="assets/libs/echarts/echarts.min.js">
  </script>
  <!-- echarts init -->
  <script src="assets/js/pages/echarts.init.js">
  </script>
