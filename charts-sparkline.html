...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Sparkline Chart | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
 ...
 <body>
      ...
      <div class="row">
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="text-center" data-colors='["#2ab57d", "#5156be", "#e9ecef"]' id="sparkline1">
          </div>
         </div>
        </div>
       </div>
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="text-center" data-colors='["#2ab57d"]' id="sparkline2">
          </div>
         </div>
        </div>
       </div>
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         ...
         <div class="card-body analytics-info">
          <div data-colors='["#5156be"]' id="sparkline4">
          </div>
         </div>
        </div>
       </div>
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="text-center" data-colors='["#5156be", "#2ab57d"]' id="sparkline3">
          </div>
         </div>
        </div>
       </div>
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="text-center" data-colors='["#5156be", "rgba(81, 86, 190, 0.3)", "#2ab57d", "rgba(42, 181, 125, 0.3)"]' id="sparkline5">
          </div>
         </div>
        </div>
       </div>
       <div class="col-xl-4 col-sm-6">
        <div class="card bg-primary">
         ...
         <div class="card-body">
          <div class="text-center" data-colors='["#fff"]' id="sparkline6">
          </div>
         </div>
        </div>
       </div>
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="text-center" data-colors='["#5156be", "#fd625e"]' id="sparkline7">
          </div>
         </div>
        </div>
       </div>
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="text-center" data-colors='["#2ab57d"]' id="sparkline8">
          </div>
         </div>
        </div>
       </div>
       <div class="col-xl-4 col-sm-6">
        <div class="card">
         ...
         <div class="card-body">
          <div class="text-center" data-colors='["#5156be", "#2ab57d", "#f46a6a"]' id="sparkline9">
          </div>
         </div>
        </div>
       </div>
  ...
  <!-- jquery-sparkline js -->
  <script src="assets/libs/jquery-sparkline/jquery.sparkline.min.js">
  </script>
  <!-- sparkline init -->
  <script src="assets/js/pages/sparklines.init.js">
  </script>
