...
<html lang="en">
 <head>
  <meta charset="utf-8"/>
  <title>
   Invoice Detail | StarCode Kh - Minimal Admin &amp; Dashboard Template
  </title>
        ...
        <div class="card">
         <div class="card-body">
          <div class="invoice-title">
           ...
           <p class="mb-1">
            1874 County Line Road City, FL 33566
           </p>
           <p class="mb-1">
           ...
           <div class="table-responsive">
            <table class="table table-nowrap align-middle mb-0">
             ...
             <tbody>
              ...
              <tr>
               <th class="text-end" colspan="2" scope="row">
                Sub Total
               </th>
               <td class="text-end">
                $998.00
